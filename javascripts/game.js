...
function rpsAnimSeq(){
  // Set animation Clock to 0
  var animationClock = 0;
  // Hide Scoreboard
  $('.score').fadeIn(250).delay(300);
  $('.round-counter').fadeIn(450).delay(300);
  // Function used in animation sequence to clear fontawesome classes
  ...
  // use animation helpers and increment clock for smooth animation
  anim800('rock');
...
// decides what to do at the end of the game
function endGame(){
  if(roundCounter > 10){
...
// Start leaderboard code for firebase
